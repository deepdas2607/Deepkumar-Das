          ...
          >
            ...
            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <div className="block mb-4 font-bold text-left text-neutral-300 md:hidden">
                ...
                <h3 className="text-lg text-neutral-400 whitespace-pre-line">{item.title}</h3>
                <h3 className="text-base text-neutral-500 whitespace-pre-line">{item.job}</h3>
              </div>
              {item.contents.map((content, index) => (
                <p className="mb-3 text-lg md:text-xl font-normal text-neutral-400" key={index}>
                  {content}
                </p>
              ))}
            </div>
